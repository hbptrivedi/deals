 ...
 * @since      1.0.0
 */
class Daily_Ads125_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-daily-ad125 widget_125',
			'description' => __( 'Easily to display any type of ad.', 'daily' )
		);

		// Create the widget.
		parent::__construct(
			'daily-ad125',                                  // $this->id_base
			__( '&raquo; Advertisement 125x125', 'daily' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'    => esc_html__( 'Advertisement', 'daily' ),
			'ad_code1' => '',
			'ad_code2' => '',
			'ad_code3' => '',
			'ad_code4' => '',
