...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'flatline' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'flatline' ),
		'repeat-y'  => __( 'Repeat Vertically', 'flatline' ),
		'repeat'    => __( 'Repeat All', 'flatline' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'flatline' ),
		'top center'    => __( 'Top Center', 'flatline' ),
		'top right'     => __( 'Top Right', 'flatline' ),
		'center left'   => __( 'Middle Left', 'flatline' ),
		'center center' => __( 'Middle Center', 'flatline' ),
		'center right'  => __( 'Middle Right', 'flatline' ),
		'bottom left'   => __( 'Bottom Left', 'flatline' ),
		'bottom center' => __( 'Bottom Center', 'flatline' ),
		'bottom right'  => __( 'Bottom Right', 'flatline')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'flatline' ),
		'fixed'  => __( 'Fixed in Place', 'flatline')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'flatline' ),
		'italic'      => __( 'Italic', 'flatline' ),
		'bold'        => __( 'Bold', 'flatline' ),
		'bold italic' => __( 'Bold Italic', 'flatline' )
		);
