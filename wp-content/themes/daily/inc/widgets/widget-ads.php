 ...
 * @since      1.0.0
 */
class Daily_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-daily-ad ad-widget',
			'description' => __( 'Easily to display any type of ad.', 'daily' )
		);

		// Create the widget.
		parent::__construct(
			'daily-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'daily' ), // $this->name
