<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<?php if ( has_post_thumbnail() ) : ?>
		<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'daily-classic-thumb', array( 'class' => 'entry-thumbnail', 'alt' => esc_attr( get_the_title() ) ) ); ?></a>
	<?php endif; ?>
	...
	<div class="entry-content" <?php hybrid_attr( 'entry-summary' ); ?>>
		<?php echo wp_trim_words( get_the_excerpt(), 40 ); ?><div class="more-link"><a href="<?php the_permalink(); ?>"><?php _e( 'Read more &raquo;', 'daily' ); ?></a></div>
	</div><!-- .entry-content -->  
